...
module.exports = msgHandler = async (bocchi = new Client(), message) => {
    try {
        ...
        switch (command) {
            ...
            case prefix+'ytmp4':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                if (!isUrl(url) && !url.includes('youtube.com')) return await bocchi.reply(from, ind.wrongFormat(), id)
                if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await bocchi.reply(from, ind.limit(), id)
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await bocchi.reply(from, ind.wait(), id)
                downloader.ytdl(url)
                    .then(async ({ result }) => {
                            ...
                            await bocchi.sendFileFromUrl(from, result.UrlVideo, `videoyt.mp4`, '', id)
                ...
                misc.igStalk(q)
                    .then(async ({ result }) => {
                        if (result === undefined) {
                            ...
                            const { biography, follower, follow, full_name, is_private, picture, username, post_count } = result
            ...
            case prefix+'neko':
                ...
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await bocchi.reply(from, ind.wait(), id)
                console.log('Get random neko image...')
                await bocchi.sendFileFromUrl(from, `https://api.lolhuman.xyz/api/random/neko?apikey=aominehg`, 'waifu.jpg', '', id)
            ...
            case prefix+'chara':
                ...
                await bocchi.reply(from, ind.wait(), id)
                try {
                    const chara_key = await axios.get(`https://api.lolhuman.xyz/api/character?apikey=${config.lol}&query=${q}`)
            ...
            case prefix+'wp':
                ...
                limit.addLimit(sender.id, _limit, isPremium, isOwner)
                await bocchi.reply(from, ind.wait(), id)
                console.log('Get random wallpaper image...')
                await bocchi.sendFileFromUrl(from, `https://api.lolhuman.xyz/api/random/wallnime?apikey=aominehg`, 'waifu.jpg', '', id)
                .then(() => console.log('Success sending wallpaper!'))
                    .catch(async (err) => {
                        console.error(err)
                        await bocchi.reply(from, 'Error!', id)
                    })
            ...
            case prefix+'tebakgambar':
                ...
                fun.tbkgmbr()
                    .then(async ({ result }) => {
                        await bocchi.sendFileFromUrl(from, result.image, 'TebakGambar.jpg', '', id)
                        ...
                        await bocchi.sendText(from, '10 Detik Tersisa...')
                        await tsleep(10000)
                        await bocchi.reply(from, `➸ *Jawaban*: ${result.answer}`, id)
            ...
            case prefix+'nhdl':
                ...
                if (isGroupMsg) {
                    ...
                    nsfw.nhdl(q)
                        .then(async ({ result }) => {
                            await bocchi.sendFileFromUrl(from, result, 'doujin.pdf', '', id)
                                .then(() => console.log('Success sending Nhentai PDF!'))
                        })
                        .catch(async (err) => {
                            console.error(err)
                            await bocchi.reply(from, 'Error!', id)
            ...
            case prefix+'nhentai':
                ...
                if (isGroupMsg) {
                    ...
                    nsfw.nhentai(q)
                        .then(async ({ result }) => {
                            await bocchi.sendFileFromUrl(from, result.image, 'doujin.jpg', `Title : ${result.title_native}\nRead : ${result.read}`, id)
                                .then(() => console.log('Success sending Nhentai IMG!'))
                        })
                        .catch(async (err) => {
                            console.error(err)
                            await bocchi.reply(from, 'Error!', id)
            ...
            case prefix+'yuri':
                ...
                if (isGroupMsg) {
                    ...
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    await bocchi.reply(from, ind.wait(), id)
                    console.log('Get random yuri image . . .')
                    await bocchi.sendFileFromUrl(from, `https://api.lolhuman.xyz/api/random2/yuri?apikey=aominehg`, 'yuri.jpg', '', id)
                } else {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await bocchi.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    await bocchi.reply(from, ind.wait(), id)
            ...
            case prefix+'hololewd':
                ...
                if (isGroupMsg) {
                    ...
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    await bocchi.reply(from, ind.wait(), id)
                    console.log('Get random hololive image . . .')
                    await bocchi.sendFileFromUrl(from, `https://api.lolhuman.xyz/api/random/nsfw/hololewd?apikey=aominehg`, 'yuri.jpg', '', id)
                } else {
                    if (limit.isLimit(sender.id, _limit, limitCount, isPremium, isOwner)) return await bocchi.reply(from, ind.limit(), id)
                    limit.addLimit(sender.id, _limit, isPremium, isOwner)
                    await bocchi.reply(from, ind.wait(), id)
            ...
            case prefix+'tos':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                await bocchi.sendLinkWithAutoPreview(from, 'https://w', ind.tos(ownerNumber))
            break
            case prefix+'promote':
                if (!isRegistered) return await bocchi.reply(from, ind.notRegistered(), id)
                if (!isGroupMsg) return await bocchi.reply(from, ind.groupOnly(), id)
